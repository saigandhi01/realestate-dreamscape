      ...
      <div className="container max-w-6xl py-10">
        ...
        <Tabs defaultValue="personal" className="w-full space-y-8">
          ...
          <TabsContent value="personal" className="space-y-8">
            <div className="profile-tab-personal p-8 rounded-xl">
          ...
          <TabsContent value="portfolio" className="space-y-8">
            <div className="profile-tab-portfolio p-8 rounded-xl">
          ...
          <TabsContent value="transactions" className="space-y-8">
            <div className="profile-tab-transactions p-8 rounded-xl">
          ...
          <TabsContent value="investment" className="space-y-8">
            <div className="profile-tab-investment p-8 rounded-xl">
              <Card className="bg-card/50 backdrop-blur-sm border-primary/10 shadow-lg">
                <CardHeader className="bg-gradient-to-r from-primary/5 to-primary/10 border-b border-primary/10">
                  <div className="flex items-center justify-between">
                    <div>
